...
<head>
	...
	<link rel="stylesheet" id="astra-theme-css-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/themes/astra/assets/css/minified/main.min.css?ver=4.0.2" media="all">
	...
	<link rel="stylesheet" id="astra-google-fonts-css"
		...
		media="all">
	<link rel="stylesheet" id="wp-block-library-css" href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/css/dist/block-library/style.min.css?ver=6.1.1"
		media="all">
	...
	<link rel="stylesheet" id="elementor-icons-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/eicons/css/elementor-icons.min.css?ver=5.17.0" media="all">
	<link rel="stylesheet" id="elementor-frontend-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/css/frontend-lite.min.css?ver=3.10.1" media="all">
	<style id="elementor-frontend-inline-css">
		...
		.elementor-554 .elementor-element.elementor-element-407fcbb>.elementor-motion-effects-container>.elementor-motion-effects-layer {
			background-color: var(--e-global-color-astglobalcolor5);
			background-image: url("<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/uploads/2021/08/lotus-spa-template-section-grad-bg.svg");
		...
		.elementor-554 .elementor-element.elementor-element-272e1e1>.elementor-motion-effects-container>.elementor-motion-effects-layer {
			background-image: url("<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/uploads/2021/08/lotus-spa-template-homepage-services-section-img-bg.jpg");
	...
	<link rel="stylesheet" id="elementor-pro-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/pro-elements/assets/css/frontend-lite.min.css?ver=3.8.0" media="all">
	<link rel="stylesheet" id="font-awesome-5-all-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/all.min.css?ver=3.10.1" media="all">
	<link rel="stylesheet" id="font-awesome-4-shim-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/v4-shims.min.css?ver=3.10.1" media="all">
	...
	<link rel="stylesheet" id="elementor-icons-shared-0-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/fontawesome.min.css?ver=5.15.3" media="all">
	<link rel="stylesheet" id="elementor-icons-fa-solid-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/solid.min.css?ver=5.15.3" media="all">
...
<![endif]-->
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/font-awesome/js/v4-shims.min.js?ver=3.10.1"
		id="font-awesome-4-shim-js"></script>
	<link rel="https://api.w.org/" href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-json/index.html">
	<link rel="alternate" type="application/json" href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-json/wp/v2/pages/554/index.html">
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="./xmlrpc.php?rsd">
	<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/wlwmanifest.xml">
	<meta name="generator" content="WordPress 6.1.1">
	<link rel="canonical" href="./index.html">
	<link rel="shortlink" href="./index.html">
	<link rel="alternate" type="application/json+oembed"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-json/oembed/1.0/embed/index.html?url=https%3A%2F%2F%2F">
	<link rel="alternate" type="text/xml+oembed"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-json/oembed/1.0/embed/index.html?url=https%3A%2F%2F%2F#038;format=xml">
</head>
...
<body itemtype="https://schema.org/WebPage" itemscope="itemscope"
										...
										<div class="site-branding ast-site-identity"
											...
											<span class="site-logo-img"><a href="./index.html"
													...
													itemprop="url" aria-label="wp_elementor"><img
														src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/uploads/2021/08/site-logo.svg"
											...
											<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-96ac74f"
												...
												<div class="elementor-widget-wrap elementor-element-populated">
														...
														<div class="elementor-widget-container">
															...
															<div
																...
																<div class="elementor-custom-embed-image-overlay"
																	style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/uploads/2021/08/lotus-spa-template-homepage-video-thumbnail.jpg);">
													...
													<div class="elementor-element elementor-element-fe795e1 elementor-widget__width-initial elementor-widget-mobile__width-inherit elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box"
														...
														<div class="elementor-widget-container">
															<link rel="stylesheet"
																href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/css/widget-icon-box.min.css">
													...
													<div class="elementor-element elementor-element-bad3896 elementor-widget elementor-widget-image"
														...
														<div class="elementor-widget-container">
															<style>
																...
																src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/uploads/2021/08/lotus-spa-template-homepage-service-img.jpg"
																	...
																	<div class="elementor-testimonial-meta-inner">
																		<div class="elementor-testimonial-image">
																			<img decoding="async" width="40" height="40"
																				src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/uploads/2021/08/lotus-spa-template-testimonial-avatar-img.jpg"
	...
	<link rel="stylesheet" id="wpforms-base-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/css/wpforms-base.min.css?ver=1.7.9.1" media="all">
	<script
		id="astra-theme-js-js-extra">var astra = { "break_point": "921", "isRtl": "", "is_scroll_to_id": "", "is_scroll_to_top": "" };</script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/themes/astra/assets/js/minified/frontend.min.js?ver=4.0.2"
		id="astra-theme-js-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/pro-elements/assets/js/webpack-pro.runtime.min.js?ver=3.8.0"
		id="elementor-pro-webpack-runtime-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/js/webpack.runtime.min.js?ver=3.10.1"
		id="elementor-webpack-runtime-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/jquery/jquery.min.js?ver=3.6.1" id="jquery-core-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/js/frontend-modules.min.js?ver=3.10.1"
		id="elementor-frontend-modules-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/dist/vendor/regenerator-runtime.min.js?ver=0.13.9"
		id="regenerator-runtime-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=3.15.0" id="wp-polyfill-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/dist/hooks.min.js?ver=4169d3cf8e8d95a3d6d5" id="wp-hooks-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/dist/i18n.min.js?ver=9e794f35a71bb98672ae" id="wp-i18n-js"></script>
	...
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/pro-elements/assets/js/frontend.min.js?ver=3.8.0"
		id="elementor-pro-frontend-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/lib/waypoints/waypoints.min.js?ver=4.0.2"
		id="elementor-waypoints-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/jquery/ui/core.min.js?ver=1.13.2" id="jquery-ui-core-js"></script>
	<script
	...
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/elementor/assets/js/frontend.min.js?ver=3.10.1"
		id="elementor-frontend-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/pro-elements/assets/js/elements-handlers.min.js?ver=3.8.0"
		id="pro-elements-handlers-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/underscore.min.js?ver=1.13.4" id="underscore-js"></script>
	<script id="wp-util-js-extra">var _wpUtilSettings = { "ajax": { "url": "\/wp-admin\/admin-ajax.php" } };</script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
	<script
		id="wpforms-elementor-js-extra">var wpformsElementorVars = { "captcha_provider": "recaptcha", "recaptcha_type": "v2" };</script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/js/integrations/elementor/frontend.min.js?ver=1.7.9.1"
		id="wpforms-elementor-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/lib/jquery.validate.min.js?ver=1.19.5"
		id="wpforms-validation-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/lib/mailcheck.min.js?ver=1.1.2"
		id="wpforms-mailcheck-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/lib/punycode.min.js?ver=1.0.0"
		id="wpforms-punycode-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/js/utils.min.js?ver=1.7.9.1"
		id="wpforms-generic-utils-js"></script>
	<script src="<?php echo get_template_directory_uri(); ?>/assets/<?php echo $template_style; ?>/wp-content/plugins/wpforms-lite/assets/js/wpforms.min.js?ver=1.7.9.1" id="wpforms-js"></script>
